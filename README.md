# Voxii AI Expert Tutor — Backend + Frontend (Dev/Testing)

AI-powered tutoring platform for Australian students in Years 7–10 covering Maths, English, and Science. This is the **dev/testing environment**. Production is at [`voxii-expert-tutor`](https://github.com/robop72/voxii-expert-tutor).

**Live URL:** https://llm-math-education.vercel.app  
